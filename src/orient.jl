"
    orientUnit(eph,JD0,time,target,unit)
...
"
function orientUnit(eph::Ephem,JD0::Float64,time::Float64,
...
"
    orientOrder(eph,JD0,time,target,unit,order)
...
If order equals to 1, the behavior of orientOrder is the same as that of orientUnit.

"
function orientOrder(eph::Ephem,JD0::Float64,time::Float64,
